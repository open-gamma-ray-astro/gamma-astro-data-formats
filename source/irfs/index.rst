...
* Full-enclosure IRF: contain the instrument response for the whole field of view (FoV) of the instrument.
...
* Point-like IRF: contain the instrument response for a given point within the FoV, which restricts their
